...
describe CheckTranslation do
  ...
  it 'check_translation Eng OK levenshtein_distance' do
    check_translation(create(:card, :levenshtein_distance_1), 'house', :success?, true)
  end
  ...
  it 'check_translation Rus OK levenshtein_distance' do
    check_translation(create(:card, :rus_levenshtein_distance_1), 'дом', :success?, true)
  end
  ...
  it 'check_translation Eng NOT levenshtein_distance=2' do
    check_translation(create(:card, :levenshtein_distance_2), 'RoR', :success?, false)
  end

  it 'check_translation Rus NOT levenshtein_distance=2' do
    check_translation(create(:card, :rus_levenshtein_distance_2), 'RoR', :success?, false)
  end
end
